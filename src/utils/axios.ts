...
export const geCoordinatesDataByCityName = async (cityName: string) => geocodingAPIInstance
  .get<{name: string, lat: number, lon: number, country: string}>(`/1.0/direct?q=${cityName}&appid=49e554f6956b3cc8ebe95b6374266b87`);
...
export const getWeatherDataByCoordinates = async (
  ...
  return wheatherAPIInstance
    .get <Response>(`/onecall?lat=${lat}&lon=${lon}${filters},hourly&appid=49e554f6956b3cc8ebe95b6374266b87`);
};
